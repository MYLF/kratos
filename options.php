...
function optionsframework_options(){
    ...
    $options[] = array(
        ...
        'options'=>array(
        'fancybox'=>'Fancybox',
        'layui_layer_photo'=>'Layui Layer Photo'));
    $options[] = array(
        'desc'=>'LayuiLayerPhoto --- kratos主题曾经集成灯箱,移动端体验不是很友好');
    $options[] = array(
        'desc'=>'Fancybox --- Github上的开源灯箱插件,具有多种动画效果,相比前者移动端体验要好很多');
    $options[] = array(
        'name'=>'强制开启Fancybox',
        'desc'=>'使用后可以强制开启Fancybox灯箱,否则需要在选择Fancybox后写文章时将图片类型设置为链接到媒体,才能在相应图片上开启Fancybox。需要在上方将灯箱类型设置为fancybox后才可生效',
        'id'=>'fancybox_force',
        'std'=>'1',
        'type'=>'checkbox',);
    $options[] = array(
        'name'=>'Fancybox按钮设置',
        'desc'=>'在下方配置在Facybox页面右上角显示的按钮(从左到右按照设置的顺序显示)');
    $options[] = array(
        'desc'=>'按钮1',
        'id'=>'fancybox_button1',
        'std'=>'slideShow',
    ...
    $options[] = array(
        ...
        'options'=>array(
            ...
            'false'=>'关闭'));
    $options[] = array(
        'desc'=>'Fancybox的打开/关闭动画效果',
        'id'=>'fancybox_animationeffect',
        'std'=>'zoom-in-out',
        'type'=>'select',
        'class'=>'mini',
        'options'=>array(
        ...
        ''=>'无'));
    $options[] = array(
        'desc'=>'Fancybox的图片切换动画效果',
        'id'=>'fancybox_transitioneffect',
        'std'=>'zoom-in-out',
        'type'=>'select',
        'class'=>'mini',
        'options'=>array(
